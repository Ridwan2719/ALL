<?php
	...
	if( isset($_POST["username"]) && isset($_POST["password"])   ) {
		...
		$result = mysqli_query($conn, "SELECT * FROM login where id = '".$username."' and pass='".$password."' ");
		
		//cek usernameW
		if(mysqli_num_rows($result) == 1 ) {
	
			//cek password
			//sudah bisa silakan lanjutkan.
			
			//pakai session buat deteksi sudah login apa belum... dan function koneksi usahakan bisa reuseable..
	...
	<form action="login.php" method="post">
      ...
      <div class="login__form">
        <div class="login__row">
          ...
          <input type="text" class="login__input name" placeholder="Username" id="id" name="username"/>
        </div>
        <div class="login__row">
          ...
          <input type="password" class="login__input pass" placeholder="Password" id="pass" name="password"/>
        </div>
